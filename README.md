...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-b2ignyk.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-b2ignyk.containers.anotherwebservice.com/
...
```
git clone git@github.com:AzizOums/container-b2ignyk.git
cd container-b2ignyk
```
...
```
docker attach container-b2ignyk
```
